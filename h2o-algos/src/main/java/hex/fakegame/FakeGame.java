...
/**
 *  FakeGame model builder... building a trivial FakeGameModel
 */
public class FakeGame extends ModelBuilder<FakeGameModel,FakeGameParameters,FakeGameOutput> {
  ...
  public FakeGame(boolean startup_once) {super(new FakeGameParameters(),startup_once);}
  public FakeGame( FakeGameParameters parms ) { super(parms); init(false); }
  @Override protected FakeGameDriver trainModelImpl() { return new FakeGameDriver(); }
